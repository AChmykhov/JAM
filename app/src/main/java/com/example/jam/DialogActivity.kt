...
//        setContentView(R.layout.activity_main)
    ...
    fun urlEncode(text: ByteArray): String {
        return URLEncoder.encode(Base64.encodeToString(text, Base64.URL_SAFE),"UTF-8")
    }

    fun urlDecode(text: String): ByteArray {
        return Base64.decode(URLDecoder.decode(text,"UTF-8"), Base64.URL_SAFE)
    }
        ...
        override fun serve(session: IHTTPSession): Response {
            ...
            when {
                params.containsKey("message") -> {  //Tyk
                    try {
                        val externalMessage = decodeMessageFromParams(params, this@DialogActivity.keyPair.private)
                ...
                params.containsKey("newMessage") -> {
                    val publKey = this@DialogActivity.keyPair.public.encoded
